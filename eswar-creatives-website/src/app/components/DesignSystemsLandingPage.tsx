  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:description" content="Enterprise Design Systems Architect for B2B SaaS. Built CYGNVS: 60+ components, 180+ semantic tokens, web, iOS, and Android in 14 weeks. $3.25M ARR platform. Start with a $750 UX Audit." />
        ...
        <meta name="twitter:description" content="Enterprise Design Systems Architect for B2B SaaS. Built CYGNVS: 60+ components, 180+ semantic tokens, web, iOS, and Android in 14 weeks. $3.25M ARR platform. Start with a $750 UX Audit." />
