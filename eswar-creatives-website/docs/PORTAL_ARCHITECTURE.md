...
_Activity tab next-due-step visibility + email preview/approve on Activity rows (`fix/activity-tab-step-visibility-and-preview`, no migrations, 2 commits, 8 Aug 2026):_
...
_Activity tab row layout + FadeOverflow (`fix/activity-tab-layout-and-fade-overflow`, no migrations, 2 commits, 8 Aug 2026):_
