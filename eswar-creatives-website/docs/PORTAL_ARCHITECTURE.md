...
Last updated: 6 August 2026 (PR #19 — Review in Advance redesign, editable lead segments, additive multi-sort, Outreach Skills, and a unified business-hours scheduling engine — migrations 0089-0092, merged staging → main). Keep this in the repo at `docs/PORTAL_ARCHITECTURE.md` and point Claude Code at it before starting any portal work.
