...
**Active branch:** `main`
**Status:** Stable. Three branches merged to `main` on 9 August 2026: `feature/shared-pagination`, then `fix/sticky-pagination-and-leads-scroll`, then `fix/pagination-scroll`. One `--no-ff` merge commit each, no migrations, build verified clean after each.
