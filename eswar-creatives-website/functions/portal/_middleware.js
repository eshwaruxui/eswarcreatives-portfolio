...
// injects the portal-specific block before </head>.
// Applied to all requests — OG tags live in <head> and don't affect rendering.

const TITLE = 'Client Portal · Eswar Creatives'
const DESC  = 'Track projects, approve proposals, and pay invoices — all in one place.'
const IMAGE = 'https://www.eswarcreatives.in/og-portal.png'
const URL   = 'https://www.eswarcreatives.in/portal/'
